...
namespace CMPG223_Project
{
    partial class frmUpdateBookings
    {
        ...
        private void InitializeComponent()
        {
			...
			this.btnUpdateBooking.Margin = new System.Windows.Forms.Padding(4, 4, 4, 4);
			...
			this.lblBenID.Click += new System.EventHandler(this.lblBenID_Click);
			// 
			// lblCheckOut
			// 
			...
			this.lblBookingID.Click += new System.EventHandler(this.lblBenID_Click);
			// 
			// txtBookingID
			// 
